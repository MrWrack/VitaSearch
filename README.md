...
- RC45 Proxy Manager is retained and updated to RC56.
...
## RC56 search + Spotify connection fix
...
## RC56 Spotify CONNECT reliability
...
## RC56 About/version update fix
- Fixed the About screen which was still hard-coded to show `VitaSearch v0.99 RC45`.
- About now uses a single `VITASEARCH_RELEASE` constant and shows `VitaSearch v0.99 RC56`.
- RC51 L-stick no-freeze and Spotify fixes are retained.

## RC56 - Web input keyboard + lower Spotify bar
...
## RC56 - Spotify login field + uppercase keyboard fix
